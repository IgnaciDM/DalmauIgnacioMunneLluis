...
public class LlistaIncidenciesTest {
    ...
    void testConstructor() {
        ...
        assertEquals(2, llistaIncidencies.getLlistaIncidencies().length);
    }

    @Test
    void testAfegirIncidencia() throws ExcepcioCamping {
        int initialSize = llistaIncidencies.getLlistaIncidencies().length;
        Incidencia newIncidencia = new Incidencia(3, Incidencia.TipusIncidencia.Tancament, parcela, "2023-05-03");
        ...
        assertEquals(initialSize + 1, llistaIncidencies.getLlistaIncidencies().length);
    }
