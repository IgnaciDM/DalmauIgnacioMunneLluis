...
public abstract class Allotjament implements InAllotjament, Serializable {
    ...
    public boolean getEstat() {
        return estat;  // Retorna l'estat de l'allotjament
    }
    ...
    public String toString() {
        return "[Nom=" + nom + ", Id=" + id + ", estada mínima en temp ALTA: " + estadaMinimaAlta + ", estada mínima en temp BAIXA: " + estadaMinimaBaixa + ", iluminacio: " + iluminacio;
    }
